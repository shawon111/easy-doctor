...
export default function ServicesCtaOneDark({ content = {}, slug }) {
    ...
    <section className="px-6 md:px-10 pb-16 pt-16">
      <div className="max-w-[1440px] mx-auto bg-cobalt rounded-[3rem] p-16 text-center text-white relative overflow-hidden group">
        <div className="relative z-10 space-y-8">
          {content.heading ? (
            <h2 className="text-4xl md:text-5xl font-display-lg uppercase italic">{content.heading}</h2>
          ) : null}
          {content.body ? (
            <p className="text-white/80 max-w-xl mx-auto text-body-lg">{content.body}</p>
          ) : null}
