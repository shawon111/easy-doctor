...
export default function AppointmentHeroOneDark() {
  return (
    <SectionFadeOneDark className="relative py-[120px] px-5 md:px-16 overflow-hidden">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="z-10">
          ...
          <h1 className="font-display-lg text-display-lg-mobile md:text-display-lg mb-8 text-on-background uppercase italic">
            Secure Your <span className="text-cobalt">Medical Slot.</span>
          </h1>
          <p className="text-body-lg text-on-surface-variant mb-10 max-w-xl border-l-2 border-cobalt pl-6">
            Clinical elegance meets high-tech scheduling. Connect via our encrypted WhatsApp link for priority booking
            and professional care diagnostics.
          </p>
        ...
        <div className="relative hidden lg:block">
          <div className="rounded-xl overflow-hidden aspect-[4/5] relative border border-white/10 glass-card p-2">
            ...
            <div className="absolute top-8 right-8 bg-cobalt/20 backdrop-blur-md border border-cobalt/40 px-4 py-2 rounded-md font-label-sm text-cobalt flex items-center gap-2">
      ...
      <div className="absolute bottom-0 left-1/4 w-64 h-64 bg-neon-mint/5 rounded-full blur-[100px] -z-10" aria-hidden="true" />
    </SectionFadeOneDark>
  );
}
