...
export default function HeroOneDark({ slug }) {
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-10 w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-20">
        <RevealOneDark>
          ...
          <h1 className="font-display-lg text-6xl md:text-8xl text-secondary mb-8 leading-[0.9] tracking-tighter">
            Expert Care <br />
            with a <span className="text-primary">Personal Touch</span>
          </h1>
          <p className="font-body-lg text-xl text-on-surface-variant mb-12 max-w-lg leading-relaxed">
            Dr. Julian Vance combines thirty years of clinical excellence with a human-centric approach to modern
            diagnostics and holistic wellness.
          </p>
        ...
        <RevealOneDark className="relative delay-200">
          <div className="aspect-[4/5] rounded-xl overflow-hidden glass-card p-2 border border-white/10">
            <img
              ...
              alt="A professional portrait of Dr. Julian Vance"
          ...
          <div className="absolute -bottom-8 -left-8 glass-card p-8 rounded-2xl hidden lg:block border border-white/20">
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="text-3xl font-bold text-secondary">15+ Years</p>
                <p className="text-xs font-bold tracking-widest text-primary uppercase">CLINICAL EXPERIENCE</p>
              </div>
            </div>
          </div>
        </RevealOneDark>
