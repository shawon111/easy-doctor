export default function HomeMapLocationDarkThree({ content = {} }) {
    ...
    <section className="py-32 bg-surface-container-lowest">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className="space-y-8">
          ...
          <button
            type="button"
            className="bg-surface-container-high text-on-surface px-8 py-3 rounded-lg border border-outline-variant hover:bg-surface-container transition-colors"
          >
