...
export default function HomeAboutPreviewDarkThree({ slug }) {
        ...
        <div className="order-2 md:order-1 grid grid-cols-2 gap-4">
          <div className="space-y-4 pt-12">
            {IMAGES.slice(0, 2).map((img) => (
              <div key={img.src} className={`${img.className} rounded-3xl overflow-hidden border border-outline-variant`}>
