...
export default function AppointmentChambersDarkThree() {
  return (
    <section className="mb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {CHAMBERS.map((chamber) => (
          <div
            key={chamber.title}
            className={`relative h-64 md:h-80 rounded-2xl overflow-hidden group ${chamber.className}`}
          >
            <img
              alt={chamber.alt}
            ...
            <div className="absolute bottom-6 left-6">
              <p className="font-label-sm text-label-sm text-primary mb-1 uppercase">{chamber.label}</p>
