...
export default function AppointmentPageDarkThree() {
  return (
    <div className="pt-12 pb-20 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
      <AppointmentHeroDarkThree />
      <AppointmentStepsDarkThree />
      <AppointmentScheduleDarkThree />
      <AppointmentWhatsappDarkThree />
      <AppointmentChambersDarkThree />
      <AppointmentFaqDarkThree />
    </div>
  );
}
