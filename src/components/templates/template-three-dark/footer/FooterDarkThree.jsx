...
export default function FooterDarkThree({ slug }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <a className="font-body-md text-body-md text-on-surface-variant hover:text-secondary-fixed transition-colors" href="#">
                Privacy Policy
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <Link className="font-body-md text-body-md text-on-surface-variant hover:text-secondary-fixed transition-colors" href={`${base}/services`}>
                Cardiology
              </Link>
            </li>
            <li>
