...
export default function CtaTwoDark({ slug }) {
    ...
    <section className="mb-[120px] px-5 md:px-16">
      <div className="max-w-[1200px] mx-auto glass-card bg-primary-container p-12 md:p-24 rounded-xl text-center relative overflow-hidden group">
        <div className="relative z-10 max-w-2xl mx-auto space-y-8">
          <h2 className="font-display-lg text-display-lg text-on-surface">The Pinnacle of Clinical Care</h2>
          <p className="font-body-lg text-body-lg text-on-surface-variant">
            Secure your appointment with London&apos;s leading precision specialist today. Limited intake ensures
