...
export default function TreatmentsTwoDark({ slug }) {
    ...
    <section className="py-[120px] px-5 md:px-16">
      <div className="max-w-[1200px] mx-auto mb-16 flex flex-col md:flex-row justify-between items-end gap-6">
        <div>
          ...
          <h2 className="font-headline-md text-headline-md text-on-surface italic">Signature Clinical Protocols</h2>
        </div>
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-6">
        <div className="md:col-span-8 glass-card p-12 min-h-[400px] flex flex-col justify-end relative overflow-hidden group">
          <img
            ...
            alt="A high-contrast, macro professional shot of a modern medical laser or surgical robot arm."
          ...
          <div className="relative z-10 space-y-4">
            <h3 className="font-headline-sm text-headline-sm text-on-surface">Minimally Invasive Neuro-Regeneration</h3>
        ...
        <div className="md:col-span-4 glass-card p-8 flex flex-col justify-between group">
          <div className="w-full h-48 bg-surface-container rounded-lg mb-6 overflow-hidden">
            <img
              ...
              alt="A minimalist, professional medical illustration of a DNA strand."
          ...
          <div>
            <h3 className="font-headline-sm text-headline-sm text-on-surface mb-2">Genomic Profile Screening</h3>
        ...
        <div className="md:col-span-4 glass-card p-8 group">
          ...
          <h3 className="font-headline-sm text-headline-sm text-on-surface mb-2">Longevity Optimization</h3>
        ...
        <div className="md:col-span-8 glass-card p-8 flex items-center gap-8 group">
          <div className="hidden sm:block w-48 h-48 rounded-lg overflow-hidden shrink-0">
            <img
              ...
              alt="High-end medical vials and diagnostic equipment on a clean glass surface."
          ...
          <div>
            <h3 className="font-headline-sm text-headline-sm text-on-surface mb-2">Executive Performance Medicine</h3>
            <p className="font-body-md text-body-md text-on-surface-variant mb-4">
