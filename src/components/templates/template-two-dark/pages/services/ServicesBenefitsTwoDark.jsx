const BENEFITS = [
  {
    ...
    description: "Access to proprietary diagnostic tools and surgical platforms not available in general hospitals.",
  },
  {
    icon: "lock",
  ...
  },
  {
    ...
    description: "Direct coordination with the world's leading research institutes for unique medical cases.",
  },
];

export default function ServicesBenefitsTwoDark() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
        <div className="relative">
          ...
          <img
            ...
            alt="A portrait of a distinguished male specialist doctor in a perfectly tailored charcoal medical coat."
        ...
        <div className="space-y-12 lg:pl-16">
          <div>
            <h2 className="font-headline-md text-headline-md mb-6">The Standard of Executive Care</h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant">
              We understand that our patients value discretion, time, and absolute technical certainty. Our practice is
