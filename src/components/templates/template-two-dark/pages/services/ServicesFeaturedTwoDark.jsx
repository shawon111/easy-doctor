...
export default function ServicesFeaturedTwoDark({ content = {}, slug }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div className="md:col-span-8 group relative overflow-hidden rounded-xl glass-panel p-2 h-[500px]">
          ...
          <div className="relative z-10 h-full flex flex-col justify-end p-8">
            <span className="font-label-caps text-label-caps text-tertiary mb-2">{content.badge}</span>
            <h3 className="font-headline-md text-headline-md mb-4">{content.heading}</h3>
            <p className="font-body-md text-body-md text-on-surface-variant max-w-lg mb-6">{content.body}</p>
            <Link
            ...
            >
              {content.cta} <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
            </Link>
          </div>
        </div>
        ...
        <div className="md:col-span-4 group relative overflow-hidden rounded-xl glass-panel p-2 h-[500px] flex flex-col">
          ...
          <div className="p-8 flex-1 flex flex-col justify-center">
            <h3 className="font-headline-sm text-headline-sm mb-3">{secondary.heading}</h3>
            <p className="font-body-md text-body-md text-on-surface-variant mb-4">{secondary.body}</p>
