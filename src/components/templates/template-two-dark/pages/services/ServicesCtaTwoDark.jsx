...
export default function ServicesCtaTwoDark({ content = {}, slug , isDemo = false}) {
  ...
  return (
    <section className="py-[120px] px-5 md:px-16 relative overflow-hidden">
      <div className="max-w-[1200px] mx-auto relative z-10 glass-panel p-12 md:p-20 rounded-2xl text-center border border-tertiary/20">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-10">{content.body}</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            {content.primaryCta} <span className="material-symbols-outlined">calendar_today</span>
          </Link>
          <Link
