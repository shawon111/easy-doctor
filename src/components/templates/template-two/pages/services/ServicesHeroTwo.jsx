export default function ServicesHeroTwo() {
  return (
    <section className="relative min-h-[614px] flex items-center justify-center pt-20 overflow-hidden">
      <div className="relative z-10 text-center max-w-4xl px-[20px]">
        ...
        <h1 className="svctwo-display-lg-mobile mb-6 text-[#1a1c1e]">
          Specialized Treatments &amp; Procedures
        </h1>
        <p className="svctwo-body-lg text-[#44474e] max-w-2xl mx-auto">
          Advanced clinical mastery combined with white-glove executive care.
          We utilize the frontier of medical technology to deliver results
