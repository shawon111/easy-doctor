export default function AppointmentHeroTwo() {
  return (
    <section className="relative pt-[120px] pb-20 px-[20px] md:px-[64px] text-center">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <h1 className="apttwo-display-lg-mobile text-[#0f172a]">
          Book Your Consultation
        </h1>
        <p className="apttwo-body-lg text-[#475569] max-w-2xl mx-auto leading-relaxed">
          Secure your priority appointment with one of the world&apos;s
          leading specialists. Our concierge-style booking ensures your
          journey to health is handled with absolute discretion and clinical
          mastery.
        </p>
