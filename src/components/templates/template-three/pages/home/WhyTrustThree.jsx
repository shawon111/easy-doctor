export default function WhyTrustThree({ content = {} , isDemo = false}) {
  ...
  return (
    <section className="py-32 bg-surface-container-lowest">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="bg-surface-container h-full rounded-[40px] relative overflow-hidden flex items-center justify-center border border-outline-variant/30">
