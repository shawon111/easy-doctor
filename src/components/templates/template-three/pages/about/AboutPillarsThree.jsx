...
const PILLAR_STYLES = [
  { iconClass: "bg-primary-container text-primary", shadowClass: "hover:shadow-primary/5" },
  { iconClass: "bg-secondary-container text-secondary", shadowClass: "hover:shadow-secondary/5" },
  { iconClass: "bg-tertiary-container text-tertiary", shadowClass: "hover:shadow-tertiary/5" },
];

export default function AboutPillarsThree({ content = {} , slug, isDemo = false}) {
