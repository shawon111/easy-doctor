...
export default function ServicesTreatmentsThree() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          <div className="md:col-span-8 glass-card rounded-xl p-8 flex flex-col md:flex-row gap-8 hover-lift cursor-default overflow-hidden">
            <div className="md:w-1/2">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary-container text-on-primary-container rounded-lg mb-6">
                <span className="material-symbols-outlined text-[18px]">favorite</span>
                <span className="font-label-sm text-label-sm font-semibold">CARDIOLOGY</span>
              </div>
              ...
              <button type="button" className="flex items-center gap-2 text-primary font-bold hover:gap-4 transition-all">
                Learn More <span className="material-symbols-outlined text-xl">arrow_forward</span>
              </button>
            </div>
          ...
          <div className="md:col-span-4 glass-card rounded-xl p-8 flex flex-col hover-lift cursor-default">
            <div className="inline-flex w-fit items-center gap-2 px-3 py-1 bg-tertiary-container text-on-tertiary-container rounded-lg mb-6">
              <span className="material-symbols-outlined text-[18px]">genetics</span>
              <span className="font-label-sm text-label-sm font-semibold">LONGEVITY</span>
            </div>
            ...
            <button type="button" className="flex items-center gap-2 text-tertiary font-bold hover:gap-4 transition-all">
              View Protocols <span className="material-symbols-outlined text-xl">arrow_forward</span>
            </button>
          </div>

          <div className="md:col-span-4 glass-card rounded-xl p-8 flex flex-col hover-lift cursor-default">
            <div className="inline-flex w-fit items-center gap-2 px-3 py-1 bg-secondary-container text-on-secondary-container rounded-lg mb-6">
              <span className="material-symbols-outlined text-[18px]">spa</span>
              <span className="font-label-sm text-label-sm font-semibold">WELLNESS</span>
            </div>
            ...
            <button type="button" className="flex items-center gap-2 text-secondary font-bold hover:gap-4 transition-all">
              Explore Wellness <span className="material-symbols-outlined text-xl">arrow_forward</span>
            </button>
          </div>
          ...
          <div className="md:col-span-8 glass-card rounded-xl p-8 flex flex-col md:flex-row-reverse gap-8 hover-lift cursor-default overflow-hidden">
            <div className="md:w-1/2">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-surface-container text-on-surface-variant rounded-lg mb-6">
                <span className="material-symbols-outlined text-[18px]">medical_services</span>
                <span className="font-label-sm text-label-sm font-semibold">FAMILY CARE</span>
              </div>
